      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 20px; color: #333333;">
          ...
          <div style="margin: 30px 0; text-align: center;">
            <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #ff6b00; background-color: #fff4e6; padding: 15px 25px; border-radius: 8px;">${escapeHtml(otp)}</span>
          </div>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 10px; overflow: hidden;">
        ...
        <div style="padding: 24px; color: #333333; background: #ffffff;">
          ...
          <div style="margin: 28px 0; text-align: center;">
            <span style="font-size: 34px; font-weight: bold; letter-spacing: 7px; color: #ff6b00; background-color: #fff4e6; padding: 16px 26px; border-radius: 10px;">${escapeHtml(otp)}</span>
          </div>
          <p style="font-size: 14px; color: #666666;">This code is valid for 15 minutes.</p>
...
export const sendProfileChangeNotice = async (
  ...
  const changeItems = changes.map((change) => `<li>${escapeHtml(change)}</li>`).join('');
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 20px; color: #333333;">
          ...
          <div style="margin: 30px 0; text-align: center;">
            <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #0090FF; background-color: #e6f4ff; padding: 15px 25px; border-radius: 8px;">${escapeHtml(otp)}</span>
          </div>
          <p style="font-size: 14px; color: #666666;">This code is valid for 15 minutes.</p>
