...
router.put('/settings', sensitiveLimiter, validateWorkerSettings, updateWorkerSettings);
router.put('/change-password', sensitiveLimiter, validateChangePassword, changeWorkerPassword);
router.post('/email-change/request', sensitiveLimiter, validateEmailChangeRequest, requestWorkerEmailChangeToken);
router.post('/email-change/verify', sensitiveLimiter, validateTokenOnly, verifyWorkerEmailChangeToken);
