    ...
    <div className="flex max-h-[min(82vh,780px)] flex-col overflow-hidden rounded-[28px] border border-white/80 bg-white/95 shadow-[0_28px_70px_rgba(15,23,42,0.16)] backdrop-blur-xl">
      <div className="custom-scrollbar min-h-0 flex-1 overflow-y-auto p-5 pb-4">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="shrink-0 rounded-full border border-slate-200 bg-white px-3 py-1 text-[9px] font-black uppercase text-slate-600">
        ...
        <button
          type="button"
          onClick={onReport}
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-red-200 bg-red-50 py-3 text-sm font-black text-red-700 transition hover:bg-red-100"
        >
