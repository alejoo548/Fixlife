...
export function ServiceRequestPanelShell({
    ...
    return (
        <motion.div
            ...
            className={`pointer-events-auto flex flex-col bg-white/96 z-20 border-white/70 backdrop-blur-xl dark:bg-slate-900/70 dark:border-white/10 ${
                isDesktopSheet
                    ? guidedBooking
        ...
        >
            ...
            {/* Content */}
            <div className="flex-1 overflow-y-auto custom-scrollbar relative bg-slate-50/70 dark:bg-white/[0.04]">
                {children}
            </div>
        </motion.div>
    );
