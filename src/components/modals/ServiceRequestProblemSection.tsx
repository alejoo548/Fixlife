        ...
        <>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
                ...
                <label className="block cursor-pointer">
                    <div className="w-full rounded-2xl border-2 border-dashed border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800 hover:border-slate-300 dark:hover:border-white/20 transition-all duration-200 p-6 text-center group">
                        <div className="w-12 h-12 rounded-full bg-white dark:bg-slate-700 shadow-sm border border-slate-100 dark:border-white/10 flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
            ...
            {showBudget && <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
                ...
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:bg-white dark:focus:bg-slate-800 rounded-xl py-4 pl-10 pr-16 text-slate-900 dark:text-slate-100 font-bold text-lg outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all placeholder-slate-300 dark:placeholder-slate-500 shadow-sm"
                        value={price}
                    ...
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-400 text-sm font-bold bg-white dark:bg-slate-700 px-2 py-1 rounded-md shadow-sm border border-slate-100 dark:border-white/10">USD</span>
                </div>
            ...
            {showActions && <div className="mt-6 space-y-3 sticky bottom-0 bg-gradient-to-t from-white dark:from-slate-900 via-white dark:via-slate-900 to-transparent pt-4 pb-2 z-10">
                <motion.button
