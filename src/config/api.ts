...
export const API_ENDPOINTS = {
  ...
  services: {
    ...
    accountBalance: `${API_URL}/api/services/account-balance`,
    penaltyAppeal: (idPenalty: number) => `${API_URL}/api/services/penalties/${idPenalty}/appeal`,
    penaltyPaymentReport: (idPenalty: number) => `${API_URL}/api/services/penalties/${idPenalty}/payment-report`,
    ...
    reportWorkerNoShow: (idRequest: number) => `${API_URL}/api/services/requests/${idRequest}/no-show`,
  ...
  admin: {
    ...
    disputeCases: `${API_URL}/api/admin/dispute-cases`,
    disputeCaseEvidence: (idIncident: number) => `${API_URL}/api/admin/dispute-cases/${idIncident}/evidence`,
    disputeCaseAction: (idIncident: number) => `${API_URL}/api/admin/dispute-cases/${idIncident}/actions`,
    policySettings: `${API_URL}/api/admin/policy-settings`,
    penalties: `${API_URL}/api/admin/penalties`,
    penaltyDetail: (idPenalty: number) => `${API_URL}/api/admin/penalties/${idPenalty}`,
    penaltyAction: (idPenalty: number) => `${API_URL}/api/admin/penalties/${idPenalty}/actions`,
    penaltyAppealAction: (idAppeal: number) => `${API_URL}/api/admin/penalty-appeals/${idAppeal}/actions`,
    uploadModeration: `${API_URL}/api/admin/upload-moderation`,
    approveSafeSkippedUploads: `${API_URL}/api/admin/upload-moderation/bulk/approve-safe-skipped`,
    uploadModerationAction: (idReview: number) => `${API_URL}/api/admin/upload-moderation/${idReview}/actions`,
    assistantContext: `${API_URL}/api/admin/assistant/context`,
    assistantChat: `${API_URL}/api/admin/assistant/chat`,
    assistantLiveKitToken: `${API_URL}/api/admin/assistant/livekit-token`,
  },
  support: {
  ...
  worker: {
    ...
    cancelAssignedRequest: (idRequest: number) => `${API_URL}/api/worker/requests/${idRequest}/cancel`,
    reportClientNoShow: (idRequest: number) => `${API_URL}/api/worker/requests/${idRequest}/client-no-show`,
